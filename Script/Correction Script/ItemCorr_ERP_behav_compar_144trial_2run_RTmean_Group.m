...
outpath=sprintf('%s/Correlation_results/ItemCorr_ERP_behav_compar_144trial_2run_RTmean_Group/',drive);
if isdir(outpath);rmdir(outpath,'s');end;mkdir(outpath);
    ...
    for channel=1:31
        ...
        for trialid=[1112:1114 1121 1123 1124 1131 1132 1134 1141:1143 1212:1214 1221 1223 1224 1231 1232 1234 1241:1243 2112:2114 2121 2123 2124 2131 2132 2134 2141:2143 2212:2214 2221 2223 2224 2231 2232 2234 2241:2243 3112:3114 3121 3123 3124 3131 3132 3134 3141:3143 3212:3214 3221 3223 3224 3231 3232 3234 3241:3243]
            filename=sprintf('%sCorrelation_results\\ItemCorr_ERP_behav_compar_144trial_RTmean\\item%d_corr_rt.txt',drive,trialid);
            if exist(filename)
    ...
    save(sprintf('%s\\compar_corr_first3run_rt_r_result.txt',outpath),'r_result','-ascii');
    save(sprintf('%s\\compar_corr_first3run_rt_p_result.txt',outpath),'p_result','-ascii');
    save(sprintf('%s\\compar_corr_first3run_rt_t_result.txt',outpath),'t_result','-ascii');
    save(sprintf('%s\\compar_corr_first3run_rt_t_result_05.txt',outpath),'t_result_05','-ascii');
    save(sprintf('%s\\compar_corr_first3run_rt_t_result_005.txt',outpath),'t_result_005','-ascii');
    save(sprintf('%s\\compar_corr_first3run_rt_t_result_001.txt',outpath),'t_result_001','-ascii');
    ...
    save(sprintf('%s\\compar_corr_second3run_rt_r_result.txt',outpath),'r_result','-ascii');
    save(sprintf('%s\\compar_corr_second3run_rt_p_result.txt',outpath),'p_result','-ascii');
    save(sprintf('%s\\compar_corr_second3run_rt_t_result.txt',outpath),'t_result','-ascii');
    save(sprintf('%s\\compar_corr_second3run_rt_t_result_05.txt',outpath),'t_result_05','-ascii');
    save(sprintf('%s\\compar_corr_second3run_rt_t_result_005.txt',outpath),'t_result_005','-ascii');
    save(sprintf('%s\\compar_corr_second3run_rt_t_result_001.txt',outpath),'t_result_001','-ascii');
